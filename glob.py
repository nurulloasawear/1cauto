    ...
    if exel:
        ...
        while True:
            ...
            if second_pos:
                ...
                # Excel'dan keyingi qatorni olish
                rows = exel.rows()
                ...
                if start_pos:
                    ...
                    if sana:
                        ...
                        # Sanani formatlash
                        sana_text = str(excel_dict['date'])
                        if "18:00:00" not in sana_text:
                            sana_text = sana_text + " 18:00:00"
                        
                        print(str(excel_dict['date']))
                        boshqarish.write(sana_text)
                        kutish.sleep(0.5)
                        ...
                        if x_ochirish:
                            ...
                            boshqarish.write(str(round(float(excel_dict['order_number']))))
                            kutish.sleep(0.5)
                                                    ...
                                                    if x_ochirish:
                                                        ...
                                                        if podbor:
                                                            ...
                                                            if sku_add:
                                                                ...
                                                                # First pos uchun narxni kiritish
                                                                price = rasm.find(kiritishlar.prices)
                                                                print(price)
                                                                
                                                                if price and excel_dict['price'] is not None:
                                                                    print("price topildi -...")
                                                                    xx,yy = price
                                                                    kutish.sleep(0.5)
